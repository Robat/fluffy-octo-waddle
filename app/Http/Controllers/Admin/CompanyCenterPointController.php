...
class CompanyCenterPointController extends AdminBaseController
{
    ...
    {
        return View::make('admin.company_center_points.index', $this->data);
    }
    ...
    {
        $result = CompanyCenterPoint::select(['id', 'name', 'category', 'numbering', 'location', 'status', 'created_at', 'updated_at'])->where("category", $category);
    ...
    public function create()
    {
        ...
        return View::make('admin.company_center_points.create', $this->data);
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        CompanyCenterPoint::create($data);
     ...
     *
     * @param  \App\Models\CompanyCenterPoint  $companyCenterPoint
     * @return \Illuminate\Http\Response
     */
    public function show(CompanyCenterPoint $companyCenterPoint)
    {
        //
    }
    ...
    {
        $this->center_point = CompanyCenterPoint::find($id);

        $this->atests = ATest::where('frequency_id', admin()->company->frequency()->id)->get();
        $this->ctests = CTest::where('frequency_id', admin()->company->frequency()->id)->get();

        return View::make('admin.company_center_points.edit', $this->data);
    }
    ...
    {
        $center_point = CompanyCenterPoint::findOrFail($id);
