...
class CompanyPTest extends Model
{
    use HasFactory;
    protected static function boot()
    {
        ...
        static::addGlobalScope('company', function (Builder $builder) {
            if (admin()) {
                if (admin()->type == 'admin') {
                    $builder->where('company_p_tests.frequency_id', admin()->company->frequency()->id);
                }
            ...
            if (employee()) {
                $builder->where('company_p_tests.company_id', employee()->company_id);
            }
        });
    }


    protected $table = "company_p_tests";
    ...
    {
        return $query->where('company_p_tests.company_id', '=', $id);
    }
