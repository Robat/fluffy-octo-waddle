...
class ATestCTest extends Pivot
{

    protected $fillable = ['a_test_id', 'c_test_id', 'a_sort', 'c_sort', 'score', 'frequency_id', 'location'];
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope('company', function (Builder $builder) {
            ...
            if (admin()) {
                $builder->where('a_test_c_test.frequency_id', admin()->company->frequency()->id);
            }
        });
    }
